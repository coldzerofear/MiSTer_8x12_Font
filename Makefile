...
INCLUDE += -I./lib/freetype2/include
...
FREETYPE2_LIB = -Llib/freetype2/lib -lfreetype2
...
LFLAGS	= -lc -lstdc++ -lm -lrt $(IMLIB2_LIB) $(FREETYPE2_LIB) -Llib/bluetooth -lbluetooth -lpthread
